...
![equation3][linearJ]  
Let's try it! We can use randomly generated data with one feature to visualize
the cost function as a function of theta. First, we try this with the regular
linear regression:  
![graph2][lincostplot]  
